...
module.exports = function(deployer) {
  ...
  deployer.then(function() {
    ...
    return hero.defineType("Demon Lord", 4, 2, 12666, 0, 99, 4, [97, 70, 80, 33, 110], [9, 5, 8, 3, 7], [9, 8, 8, 6, 9]);
  }).then(function() {
    ...
    return hero.defineType("Celestial Mage", 3, 5, 7605, 2, 75, 3, [45, 40, 45, 70, 60], [5, 3, 6, 4, 6], [6, 6, 6, 8, 6]);
  }).then(function() {
...
module.exports = function(deployer) {
  ...
  deployer.then(function() {
    ...
    card = instance
    console.log("  Address: " + CardSwap.address);
    return card.setCryptoSagaCardSwapContract(CardSwap.address);
  }).then(function() {
    return Gold.deployed();
  }).then(function(instance) {
